...
const WireframeCard = ({ className, ...rest }: AssetProps) => (
...
const NodeGraphIcon = ({ className, accentColor, ...rest }: ColorAssetProps) => (
...
const RenderIcon = ({ className, accentColor, ...rest }: ColorAssetProps) => (
...
const ProfileCard = ({ className, ...rest }: AssetProps) => (
...
const PenIcon = ({ className, accentColor, ...rest }: ColorAssetProps) => (
...
const LikeButtonIcon = ({ className, accentColor, ...rest }: ColorAssetProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={`w-16 h-16 filter drop-shadow-lg ${className}`} style={{ color: `var(--accent-${accentColor})`, ...rest.style }}>
